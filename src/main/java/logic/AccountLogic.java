        ...
        Account account = new Account();
                ...
                if(parameterMap.containsKey(ID)){
                  ...
                  if(parameterMap.containsKey(DISPLAY_NAME)){
                       if(parameterMap.get(DISPLAY_NAME)[0].isEmpty() || parameterMap.get(DISPLAY_NAME)[0].length() > 255){
                          throw new ValidationException("Invalid Display name");
                       }else{
                  ...
                  if(parameterMap.containsKey(USER)){
                      if(parameterMap.get(USER)[0].isEmpty() || parameterMap.get(USER)[0].length() > 255) {
                  ...
                  if(parameterMap.containsKey(PASSWORD)){
                       if(parameterMap.get(PASSWORD)[0].isEmpty() || parameterMap.get(PASSWORD)[0].length() >255) {
