...
public class CreateCategory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("Url:<br>");
            out.printf("<input type=\"text\" name=\"%s\" value=\"\"required maxlength=\"255\"><br>",CategoryLogic.URL);
            out.println("<br>");
            out.println("Title:<br>");
            out.printf("<input type=\"text\" name=\"%s\" value=\"\"required maxlenghth=\"255\"><br>",CategoryLogic.TITLE);
            out.println("<br>");
   ...
   private String toStringMap(Map<String, String[]> values) {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       CategoryLogic cLogic = new CategoryLogic();
        ...
        if(null==cLogic.getWithTitle(title)){
        ...
        if( request.getParameter("add")!=null){
            ...
            response.sendRedirect("CategoryTableFancyJSP");
        }
    }
